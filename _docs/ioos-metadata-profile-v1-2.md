...
- The following list contains special QARTOD variables, distinct from QARTOD variables created by applying quality tests to specific geophysical variables:  
  - [aggregate_quality_flag](http://vocab.nerc.ac.uk/collection/P07/current/NSQIIIL7/)
  - [attenuated_signal_test_quality_flag](http://vocab.nerc.ac.uk/collection/P07/current/XORQBBJU/)
  - [climatology_test_quality_flag](http://vocab.nerc.ac.uk/collection/P07/current/U8OR7J3E/)
  - [flat_line_test_quality_flag](http://vocab.nerc.ac.uk/collection/P07/current/IMYZ46Y5/)
  - [gap_test_quality_flag](http://vocab.nerc.ac.uk/collection/P07/current/WJ0KLQVT/)
  - [gross_range_test_quality_flag](http://vocab.nerc.ac.uk/collection/P07/current/SEO24YNV/)
  - [location_test_quality_flag](http://vocab.nerc.ac.uk/collection/P07/current/1U1P3ED5/)
  - [multi_variate_test_quality_flag](http://vocab.nerc.ac.uk/collection/P07/current/6P7MT1WN/)
  - [neighbor_test_quality_flag](http://vocab.nerc.ac.uk/collection/P07/current/3ZX9BPRR/)
  - [rate_of_change_test_quality_flag](http://vocab.nerc.ac.uk/collection/P07/current/APJWQEQV/)
  - [spike_test_quality_flag](http://vocab.nerc.ac.uk/collection/P07/current/G0DMEMEL/)
...
qartod_variable:flag_values | CF | A comma-separated list of mutually exclusive values, usually short codes, each of which is the same type as the QARTOD variable with which it is associated, and together encompass all possible values that can be stored in the QARTOD variable.  See the below example for recommended usage of **`flag_values`** for QARTOD flagging.  | variable | recommended
qartod_variable:flag_meanings | CF | A space-separated list of descriptive words or phrases, listed in the same order and number as the values in the **`flag_values`** attribute.  If multi-word phrases are used to describe the flag values, the words within a phrase should be connected with underscores. See the below example for recommended usage of **`flag_meanings`** for QARTOD flagging. | variable | recommended
